...
class PhysicManager{
    ...
    update(obj){ //обновление состояния объекта
        ...
        if(obj.move_y===-1 && (tsUnder===1 || tsUnder===28)) //если прыжок и мы находимся на земле
        {
            this.heightJump = obj.pos_y - 300; //фиксируем высоту прыжка
            obj.pos_dy=40;
